...
public class P17387 {
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		if(ab==0&&cd==0) {
			if(N1.x1==N1.x2&&N1.x1==N2.x1&&N1.x1==N2.x2) {
				if(Math.min(N1.y1, N1.y2)<=Math.max(N2.y1, N2.y2) && Math.min(N2.y1, N2.y2)<=Math.max(N1.y1, N1.y2)) {
					System.out.println(1);
				}else {
					System.out.println(0);
				}
			}else {
				if(Math.min(N1.x1, N1.x2)<=Math.max(N2.x1, N2.x2) && Math.min(N2.x1, N2.x2)<=Math.max(N1.x1, N1.x2)) {
					System.out.println(1);
				}else {
					System.out.println(0);
				}
